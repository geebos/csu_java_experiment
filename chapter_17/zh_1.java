...
class drawgraph extends Frame{
    public drawgraph(){
        ...
        String sql="select score from student";
        ...
        try {
            ...
            //根据各分段人数计算各分数段对应的扇面范围大小，整个圆360度
...
class myArc extends Canvas{
    ...
    int c[][]= {{25,25,250},{223,24,123},{30,145,69},{244,80,70},{80,200,180}};
    int angle[];
    myArc(int angle[]){
        this.angle=angle;
    }
